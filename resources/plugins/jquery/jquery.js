...
var
	...
	rlocalProtocol = /^(?:about.html|app|app-storage|.+-extension|file|res|widget):$/,
	rnoContent = /^(?:GET|HEAD)$/,
	rprotocol = /^\/\//,
	 ...
	 *    - AFTER param serialization (s.data is a string if s.process.htmlData is true)
...
function ajaxHandleResponses( s, jqXHR, responses ) {
	...
	// Remove auto dataType and get content-type in the process.html
	while ( dataTypes[ 0 ] === "*" ) {
		dataTypes.shift();
		if ( ct === undefined ) {
...
jQuery.extend( {
	...
	ajax: function( url, options ) {
		...
		if ( s.data && s.process.htmlData && typeof s.data !== "string" ) {
		...
		if ( !s.hasContent ) {
			...
			// If data is available and should be process.htmled, append data to url
			if ( s.data && ( s.process.htmlData || typeof s.data === "string" ) ) {
		...
		} else if ( s.data && s.process.htmlData &&
